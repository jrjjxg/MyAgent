...
public class ConversationRouterService {
    ...
    public ConversationRouteDecision route(AgentExecutionRequest request,
    ...
    private ConversationRouteDecision fallbackDecision(String message,
                                                       List<DocumentRecord> documents,
                                                       int uploadedFileCount) {
    ...
    private static ConversationRouteDecision chatDecision() {
        return new ConversationRouteDecision(ConversationRouteKind.CHAT, "chat", true);
    }

    private static ConversationRouteDecision documentDecision() {
        return new ConversationRouteDecision(ConversationRouteKind.DOCUMENT_QA, "document-qa", true);
    }
}
