...
public class MessageController {
    ...
    public MessageController(AgentExecutionService agentExecutionService,
    ...
    public List<MessageRecord> listMessages(@CurrentUserId String userId,
        ...
        return agentExecutionService.listMessages(userId, threadId);
    }
    ...
    public SseEmitter postMessage(@CurrentUserId String userId,
        ...
        agentExecutionService.prepareMessageExecution(userId, threadId, request);
        ...
        agentExecutionExecutor.execute(() -> {
            try {
                agentExecutionService.executeMessage(userId, threadId, request, event -> sendEvent(emitter, streamClosed, event));
